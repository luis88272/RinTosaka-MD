...
handler.before = function (m) {
    ...
    let role = (user.level <= 3) ? 'Esclavo V'
      : ((user.level >= 3) && (user.level <= 6)) ? 'Esclavo IV'
      : ((user.level >= 6) && (user.level <= 9)) ? 'Esclavo III'
      : ((user.level >= 9) && (user.level <= 12)) ? 'Esclavo II'
      : ((user.level >= 12) && (user.level <= 15)) ? 'Esclavo I'
      : ((user.level >= 15) && (user.level <= 18)) ? 'Plebeyo V'
      : ((user.level >= 18) && (user.level <= 21)) ? 'Plebeyo IV'
      : ((user.level >= 21) && (user.level <= 24)) ? 'Plebeyo III'
      : ((user.level >= 24) && (user.level <= 27)) ? 'Plebeyo II'
      : ((user.level >= 27) && (user.level <= 30)) ? 'Plebeyo I'
      : ((user.level >= 30) && (user.level <= 33)) ? 'Noble V'
      : ((user.level >= 33) && (user.level <= 36)) ? 'Noble IV'
      : ((user.level >= 36) && (user.level <= 39)) ? 'Noble III'
      : ((user.level >= 39) && (user.level <= 42)) ? 'Noble II'
      : ((user.level >= 42) && (user.level <= 45)) ? 'Noble I'
      ...
      : ((user.level >= 405) && (user.level <= 700)) ? 'Realeza Boulevard 👑'
      : ((user.level >= 700) && (user.level <= 1000)) ? 'Principe 👑'
      : '👑 𝙎𝙝𝙖𝙙𝙤𝙬 𝙈𝙤𝙣𝙖𝙧𝙘𝙝 👑'
